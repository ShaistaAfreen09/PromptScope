...
import { Sparkles, Mail, Lock, AlertCircle, ArrowLeft, Loader2, Compass } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#FAF8F3] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-1.5 text-center text-xs text-[#2F3A33]/60 font-sans">
          Welcome back to PromptScope. Access your optimizer templates.
        </p>
      </div>
          ...
          <form className="space-y-5" onSubmit={handleEmailLogin}>
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label htmlFor="password" className="block text-xs font-bold text-[#2F3A33]/80 uppercase tracking-wider">
                  Password
                </label>
                <button
                  type="button"
                  onClick={() => onNavigate("forgot-password")}
                  className="text-xs font-bold text-[#8FAF9B] hover:text-[#8FAF9B]/80 transition-colors"
                >
                  Forgot password?
                </button>
              </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 bg-white text-[#2F3A33]/50">Or continue with</span>
              </div>
            </div>
